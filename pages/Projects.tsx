...
const projects: Project[] = [
  {
    id: '1',
    title: 'CodeLens: AI-Powered Code Reviews',
    description: 'An AI-powered code review tool that automatically analyzes pull requests line-by-line using Google Gemini. Features GitHub integration, RAG for codebase context, and real-time dashboard for subcription-based high-quality code reviews.',
    tags: ['Next.js 16', 'TypeScript', 'Gemini AI', 'Pinecone', 'Better Auth', 'Prisma'],
