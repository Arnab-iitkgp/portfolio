...
import { Briefcase, GraduationCap, Award,Trophy,ArrowRight, Github, Linkedin, Mail, Twitter, FileText, ArrowUpRight, FileUser, Medal } from 'lucide-react';
...
const experiences = [
  {
    ...
    period: "2023 - 2024",
    description: "Led frontend design and deployment of the society website within 7 days, ensuring a responsive UI. Organized web development workshops for 30+ students.",
  ...
  },
  {
    ...
    role: "Member",
    period: "2023 - 2024",
    description: "Organized cycle trips outside the campus and conducted technical workshops for first-year students. Participated in National & International Adventure Programs.",
...
export const Home = () => {
  ...
  return (
    <div className="space-y-12 md:space-y-16">
        ...
        >
          <div className="flex-1 space-y-6">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-lg text-lg">
              ...
              Passionate about building scalable web applications, GenAI solutions, and solving complex algorithmic problems.
            </p>
            ...
            <div className="pt-6 flex flex-col sm:flex-row gap-5 items-start sm:items-center">
                ...
                >
                    <Link to="/projects" className="bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 px-6 py-2.5 rounded-full text-sm font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors flex items-center gap-2">
                        View Work <ArrowRight className="w-4 h-4" />
                    </Link>
                    
                    <button onClick={() => window.open('/resume.pdf', '_blank')} className="px-5 py-2.5 text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 transition-colors flex items-center gap-2 rounded-full hover:bg-zinc-50 dark:hover:bg-zinc-800">
                ...
                >
                    ...
                    <div className="flex gap-1">
                        <SocialLink href="https://github.com/Arnab-iitkgp" icon={Github} />
                        <SocialLink href="https://www.linkedin.com/in/arnab-dev/" icon={Linkedin} />
                        <SocialLink href="mailto:arnabchakraborty7574@gmail.com" icon={Mail} />
                    </div>
                </motion.div>
            </div>
          </div>
      ...
      {/* Tech Stack */}
      <section>
         <h3 className="text-xs font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mb-6">Technologies</h3>
            ...
            {achievements.map((item, index) => (
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        <h4 className="font-bold text-zinc-900 dark:text-zinc-100 text-base truncate pr-4">{item.title}</h4>
                        <div className="flex flex-wrap items-center gap-2 mt-1 text-sm text-zinc-500 dark:text-zinc-400 font-medium">
                            ...
                            <span>{item.date}</span>
                            <span className="text-zinc-300 dark:text-zinc-600 hidden sm:inline">|</span>
                            <span className="text-zinc-400 dark:text-zinc-500">{item.category}</span>
                        </div>
                    </div>
      ...
      <section>
          <div className="flex justify-between items-end mb-8 border-b border-zinc-100 dark:border-zinc-800 pb-4 mt-12">
             <h2 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 font-serif">Selected Work</h2>
             <Link to="/projects" className="text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 flex items-center gap-1 group transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             {[
                 {
                    title: "EmailPro",
                    description: "Enhanced email workflows using Gemini 2.5-Flash AI, reducing manual effort by 30%.",
                    tags: ["Node.js", "React.js", "Gemini API", "Pinecone", "MongoDB"],
                    link: "https://email-assistant-five-mu.vercel.app/",
                 ...
                 {
                    title: "CargoRoute",
                    description: "VRP Optimizer with Genetic Algorithm for multi-stop delivery routes.",
                    tags: ["Algorithms", "Leaflet", "Node.js"],
                    link: "https://cargoroute-frontend.vercel.app/",
                    github: "https://github.com/Arnab-iitkgp/CargoRoute",
                    image: "/projects/cargoroute.png"
                 }
             ].map((project, index) => (
                 <Link to={project.github} key={index} className="group block">
                    <motion.div 
                      whileHover={{ y: -4 }}
                    ...
                    >
                        ...
                        <div className="w-full overflow-hidden bg-zinc-100 dark:bg-zinc-800 relative border-b border-zinc-100 dark:border-zinc-800">
                           ...
                           <div className="absolute top-3 right-3">
                                <div className="p-2 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 duration-300">
                        ...
                        <div className="p-6 flex-grow flex flex-col">
                            <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mb-2 group-hover:text-zinc-600 dark:group-hover:text-zinc-300 transition-colors">{project.title}</h3>
                            <p className="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed line-clamp-2 mb-4 flex-grow">{project.description}</p>
                            <div className="flex flex-wrap gap-2 mt-auto">
                                {project.tags.map(tag => (
                                    <span key={tag} className="px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider text-zinc-500 dark:text-zinc-400 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700 rounded-sm">
                                        {tag}
                                    </span>
                                ))}
                            </div>
      ...
      <section>
         <div className="flex justify-between items-end mb-6 mt-12">
             <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 font-serif">Recent Writing</h2>
                <div className="h-px bg-zinc-200 dark:bg-zinc-800 w-12 ml-4" />
             </div>
             <Link to="/writing" className="text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 flex items-center gap-1 group transition-colors">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {recentPosts.map((post) => (
                <Link key={post.id} to={`/writing/${post.slug}`}>
                   ...
                   >
                      <div className="text-xs font-mono text-zinc-400 dark:text-zinc-500 mb-3">{post.date}</div>
                      <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mb-2 group-hover:underline decoration-zinc-400 dark:decoration-zinc-600 underline-offset-4">{post.title}</h3>
                      <p className="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed line-clamp-2">{post.excerpt}</p>
                      <div className="mt-4 flex items-center text-xs font-bold text-zinc-900 dark:text-zinc-100 uppercase tracking-wide">
                          Read Article <ArrowUpRight className="w-3 h-3 ml-1 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
                      </div>
                   </motion.div>
                </Link>
            ))}
      ...
      <section>
        ...
        <div className="space-y-10">
          {experiences.map((job, index) => (
            <div key={index} className="group relative pl-8 border-l border-zinc-200 dark:border-zinc-800 hover:border-zinc-900 dark:hover:border-zinc-100 transition-colors duration-500">
               ...
               <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-3">
                 <div>
                    <h4 className="font-bold text-zinc-900 dark:text-zinc-100 text-lg group-hover:translate-x-1 transition-transform">{job.role}</h4>
                    <p className="text-zinc-500 dark:text-zinc-400 font-medium">{job.company}</p>
                 </div>
                 <Badge className="self-start bg-white dark:bg-zinc-900 text-zinc-600 dark:text-zinc-300 border-zinc-200 dark:border-zinc-800 font-mono">{job.period}</Badge>
               </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 items-start">
            ...
            <div className="shrink-0">
                <div className="w-40 h-40 md:w-56 md:h-56 bg-zinc-900 border border-zinc-200 dark:border-zinc-800 overflow-hidden shadow-sm relative rounded-full">
                     <img src="/pf.jpg" alt="About Me" className="w-full h-full object-cover" />
                </div>
            </div>
            ...
            <div className="flex-1 space-y-6">
                <div>
                    <h2 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 font-serif mb-2">Arnab Chakraborty</h2>
                    <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed">
                    I build full-stack applications and enjoy solving the small real-life problems that everyone ignores until they break.
                    </p>
                </div>

                <div>
                    <h3 className="text-sm font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mb-3">Key Skills</h3>
                    <div className="flex flex-wrap gap-2">
                         {['C++', 'React', 'Node.js', 'Python', 'MongoDB'].map((skill, i) => (
                             <motion.span 
                                key={skill} 
                                initial={{ opacity: 0, scale: 0.8 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                                transition={{ delay: i * 0.05 }}
                                whileHover={{ scale: 1.1, borderColor: "#a1a1aa", color: "#18181b" }}
                ...
                <div className="pt-2">
                    <button onClick={openContact} className="inline-flex items-center text-sm font-bold text-zinc-900 dark:text-zinc-100 border-b-2 border-zinc-900 dark:border-zinc-100 hover:border-zinc-500 dark:hover:border-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors pb-1">
